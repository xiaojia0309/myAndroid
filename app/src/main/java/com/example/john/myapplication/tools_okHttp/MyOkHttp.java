package com.example.john.myapplication.tools_okHttp;

import android.content.Context;
import android.os.Handler;

import com.example.john.myapplication.tools_okHttp.body.ProgressRequestBody;
import com.example.john.myapplication.tools_okHttp.body.ResponseProgressBody;
import com.example.john.myapplication.tools_okHttp.response.DownloadResponseHandler;
import com.example.john.myapplication.tools_okHttp.response.GsonResponseHandler;
import com.example.john.myapplication.tools_okHttp.response.IResponseHandler;
import com.example.john.myapplication.tools_okHttp.response.JsonResponseHandler;
import com.example.john.myapplication.tools_okHttp.response.RawResponseHandler;
